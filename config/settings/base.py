...
DATABASES = {
    "default": env.db(
        "DATABASE_URL",
        default="postgres://localhost/ieltsmock",
    ),
}
DATABASES["default"]["ATOMIC_REQUESTS"] = False
DATABASES["default"]["CONN_MAX_AGE"] = env.int("DB_CONN_MAX_AGE", default=60)

# Set before the first migration. Changing AUTH_USER_MODEL later is extremely painful.
...
# Audio uploads are capped in the upload validator; these are the hard transport limits.
...
SPECTACULAR_SETTINGS = {
    ...
    "DESCRIPTION": "Content, attempts and progress API for the PrepPath IELTS SPA.",
    "VERSION": "1.0.0",
